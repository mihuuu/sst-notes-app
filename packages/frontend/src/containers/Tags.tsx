...
export default function Tags() {
  ...
  // If a specific tag is selected, show notes filtered by that tag
  if (tag) {
    const decodedTag = decodeURIComponent(tag);
    return (
      <NotesList
        title={`Notes tagged with "${decodedTag}"`}
        tagFilter={decodedTag}
        emptyStateTitle="No notes with this tag"
        emptyStateDescription="No notes found with this tag."
        countLabel="Tagged notes"
